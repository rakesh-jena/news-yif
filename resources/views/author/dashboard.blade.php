                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <div class="social-links mt-2">
                            @if($user_meta->twitter != '#' && $author_meta->twitter != '')
                            <a href="{{$user_meta->twitter}}" class="twitter">
                                <i class="bi bi-twitter"></i>
                            </a>
                            @endif
                            @if($user_meta->facebook != '#' && $author_meta->facebook != '')
                            <a href="{{$user_meta->facebook}}" class="facebook">
                                <i class="bi bi-facebook"></i>
                            </a>
                            @endif
                            @if($user_meta->instagram != '#' && $author_meta->instagram != '')
                            <a href="{{$user_meta->instagram}}" class="instagram">
                                <i class="bi bi-instagram"></i>
                            </a>
                            @endif
                            @if($user_meta->linkedin != '#' && $author_meta->linkedin != '')
